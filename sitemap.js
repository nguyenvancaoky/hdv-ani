...
function loadtoc(a) {
    ...
    tocLoaded = true;
    displayToc2();
    document.write('</br><a href="https://workshop.wallpaperhdv.net" style="font-size: 12px; text-decoration:none; color: #616469;">workshop.wallpaperhdv.net</a>')
}
...
function hideToc() {
    ...
    b.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle(\'toc-result\',\'blind\');">?? </a> <img src="http://radiorodja.googlepages.com/new_1.gif"/>'
}
function looptemp2() {
